package com.pangliang.discountInformationMonitor.IPPoolDemo;
...
public class DataBaseDemo {
    private static String driver = "org.h2.Driver";    //数据库驱动
    private static String dbURL = "jdbc:h2:file:~/.h2/spring-boot;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE";    //操作的数据库地址，端口及库名
